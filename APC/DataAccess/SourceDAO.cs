...
namespace APC.DataAccess
{
    ...
    public class SourceDAO : ISourceDAO
    {
        ...
        /// <returns></returns>
        public SourceDAO(ILogger<SourceDAO> logger, ApcupsdClient client)
        {
            this.Logger = logger;
            this.Client = client;
        }
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                return await Task.FromResult(this.FetchAsync(key.SerialNo, cancellationToken));
            }
            catch (Exception e)
            {
                var msg = e switch
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        protected Response? FetchAsync(string host, CancellationToken cancellationToken = default)
        {
            this.Logger.LogDebug("Connecting to {host} APC UPS", host);
        ...
        /// The apcupsd client.
        /// </summary>
        private readonly ApcupsdClient Client;
    }
}
